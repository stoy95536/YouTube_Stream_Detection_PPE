...
class YouTubeObjectDetector:
    ...
    def process_frame(self, frame):
        ...
        alert_roi_points = self.alert_roi_points
        detect_roi_points = self.detect_roi_points
    ...
    def run(self):
        try:
            self.alert_roi_points = self.load_roi_polygon(path='roi_ppe_polygon.txt')
            self.detect_roi_points = self.load_roi_polygon(path='roi_polygon.txt')
